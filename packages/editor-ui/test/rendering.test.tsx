      ...
      definitions: [
        {
          kind: 'linearGradient',
          markup:
            '<linearGradient id="hero-gradient"></linearGradient><script>alert(1)</script>',
        },
      ],
      raw_root_attributes: {
        'data-safe': 'yes',
...
describe('DocumentRenderer', () => {
  it('renders scenes and loose top-level nodes in root order and resolves asset-backed backgrounds', () => {
    ...
    try {
      ...
      const card = harness.container.querySelector(
        '[data-node-id="card_1"]',
      ) as HTMLElement;
      ...
      const iconSvg = harness.container.querySelector(
        '[data-node-id="icon_svg"]',
      );
  ...
  it('treats numeric text line heights as pixel values', () => {
    ...
    try {
      const title = harness.container.querySelector(
        '[data-node-id="title_1"]',
      ) as HTMLElement;
...
describe('measurement helpers', () => {
  it('resolves containing scene roots and loose top-level roots', () => {
    ...
    expect(
      resolveMeasurementRootIds(document, [
        'title_1',
        'rect_loose',
        'circle_1',
        'primitive_loose',
