...
export function LayersInspector({
  ...
  return (
    <aside
      className="flex h-full min-h-0 w-[320px] shrink-0 self-stretch flex-col overflow-hidden border-r border-black/12 bg-[#fcfbf8]"
    ...
    >
      ...
      <div
        className="min-h-0 flex-1 overflow-auto bg-[#fcfbf8] px-2 py-2"
