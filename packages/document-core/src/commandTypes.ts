...
const createSvgVisualElementNodePayloadSchema =
  baseCreateNodePayloadSchema.extend({
  ...
  .object({
    ...
    patch: z
      .object({
        ...
        slots: z
          .object({
            'node.paint.background_color': styleSlotValueSchema
              .nullable()
              .optional(),
            'node.shape.border_radius': styleSlotValueSchema
              .nullable()
              .optional(),
      ...
      .object({
        ...
        slots: z
          .object({
            ...
            'node.typography.font_family': styleSlotValueSchema
              .nullable()
              .optional(),
            'node.typography.font_size': styleSlotValueSchema
              .nullable()
              .optional(),
            'node.typography.font_weight': styleSlotValueSchema
              .nullable()
              .optional(),
            'node.typography.line_height': styleSlotValueSchema
              .nullable()
              .optional(),
            'node.typography.letter_spacing': styleSlotValueSchema
              .nullable()
              .optional(),
          })
          .strict()
  ...
  .object({
    ...
    patch: z
      .object({
        ...
        name: z.string().optional(),
        scopes: z
          .array(z.union([canvasSemanticSlotSchema, nodeSemanticSlotSchema]))
          .optional(),
        values_by_mode: z
          .record(z.string(), variableValueByModeSchema)
          .optional(),
        description: z.string().nullable().optional(),
      })
      .strict(),
  ...
  .object({
    ...
    patch: z
      .object({
        ...
        raw_root_attributes: z
          .record(z.string(), assetSourceAttributeValueSchema)
          .optional(),
...
export type UpdateSceneMetadataCommand = z.infer<
  typeof updateSceneMetadataCommandSchema
>;
...
export type ReorderChildrenCommand = z.infer<
  typeof reorderChildrenCommandSchema
>;
export type DeleteNodeCommand = z.infer<typeof deleteNodeCommandSchema>;
export type UpdateTextContentCommand = z.infer<
  typeof updateTextContentCommandSchema
>;
export type SetCanvasLocalValueCommand = z.infer<
  typeof setCanvasLocalValueCommandSchema
>;
export type ClearCanvasLocalValueCommand = z.infer<
  typeof clearCanvasLocalValueCommandSchema
>;
export type BindCanvasVariableCommand = z.infer<
  typeof bindCanvasVariableCommandSchema
>;
export type ClearCanvasVariableBindingCommand = z.infer<
  typeof clearCanvasVariableBindingCommandSchema
>;
export type SetNodeLocalValueCommand = z.infer<
  typeof setNodeLocalValueCommandSchema
>;
export type ClearNodeLocalValueCommand = z.infer<
  typeof clearNodeLocalValueCommandSchema
>;
export type BindNodeVariableCommand = z.infer<
  typeof bindNodeVariableCommandSchema
>;
export type ClearNodeVariableBindingCommand = z.infer<
  typeof clearNodeVariableBindingCommandSchema
>;
export type BindNodeStyleCommand = z.infer<typeof bindNodeStyleCommandSchema>;
export type ClearNodeStyleBindingCommand = z.infer<
  typeof clearNodeStyleBindingCommandSchema
>;
export type CreateVariableCollectionCommand = z.infer<
  typeof createVariableCollectionCommandSchema
>;
export type UpdateVariableCollectionCommand = z.infer<
  typeof updateVariableCollectionCommandSchema
>;
export type DeleteVariableCollectionCommand = z.infer<
...
export type UpdateSvgPrimitiveCommand = z.infer<
  typeof updateSvgPrimitiveCommandSchema
>;
...
export type ApplyCommandsErrorCode = z.infer<
  typeof applyCommandsErrorCodeSchema
>;
