...
export const canvasLocalValuesSchema = z.object({
  "canvas.background_color": renderStyleValueSchema.optional()
}).strict();

export const canvasVariableBindingsSchema = z.object({
...
export const nodeLocalValuesSchema = z.object({
...
export const nodeVariableBindingsSchema = z.object({
...
export const nodeStyleBindingsSchema = z.object({
...
export const frameNodeStyleBindingsSchema = nodeStyleBindingsSchema.pick({
  paint: true
}).strict();

export const rectangleNodeStyleBindingsSchema = nodeStyleBindingsSchema.pick({
  paint: true
}).strict();

export const textNodeStyleBindingsSchema = nodeStyleBindingsSchema.pick({
  text: true
}).strict();

export const emptyNodeStyleBindingsSchema = z.object({}).strict();

export const frameNodeAuthoringSchema = z.object({
...
export const rectangleNodeAuthoringSchema = z.object({
...
export const textNodeAuthoringSchema = z.object({
...
export const emptyNodeAuthoringSchema = z.object({
...
export const assetSourceAttributeValueSchema = z.union([z.boolean(), z.number(), z.string()]);
...
export const colorVariableModeValueSchema = createVariableModeValueSchema(z.string());
export const radiusVariableModeValueSchema = createVariableModeValueSchema(renderStyleValueSchema);
export const spacingVariableModeValueSchema = createVariableModeValueSchema(renderStyleValueSchema);
export const typographyVariableModeValueSchema =
  createVariableModeValueSchema(typographyTokenValueSchema);

function createVariableSchema<TKind extends string>(kind: TKind, modeValueSchema: z.ZodTypeAny) {
  return z.object({
    id: z.string(),
...
export const colorVariableSchema = createVariableSchema("color", colorVariableModeValueSchema);
export const radiusVariableSchema = createVariableSchema("radius", radiusVariableModeValueSchema);
export const spacingVariableSchema = createVariableSchema("spacing", spacingVariableModeValueSchema);
...
export const paintStyleSlotsSchema = z.object({
  "node.paint.background_color": createStyleSlotValueSchema(z.string()).optional(),
  "node.shape.border_radius": createStyleSlotValueSchema(renderStyleValueSchema).optional(),
  "node.paint.opacity": createStyleSlotValueSchema(renderStyleValueSchema).optional()
});

export const textStyleSlotsSchema = z.object({
  "node.text.color": createStyleSlotValueSchema(z.string()).optional(),
  "node.typography.font_family": createStyleSlotValueSchema(z.string()).optional(),
  "node.typography.font_size": createStyleSlotValueSchema(renderStyleValueSchema).optional(),
  "node.typography.font_weight": createStyleSlotValueSchema(renderStyleValueSchema).optional(),
  "node.typography.line_height": createStyleSlotValueSchema(renderStyleValueSchema).optional(),
  "node.typography.letter_spacing": createStyleSlotValueSchema(renderStyleValueSchema).optional()
});
...
export const svgAttributeBagSchema = z.record(z.string(), assetSourceAttributeValueSchema);
...
export type RectangleNodeAuthoring = z.infer<typeof rectangleNodeAuthoringSchema>;
...
export type RendererVariableCollection = z.infer<typeof rendererVariableCollectionSchema>;
...
export function isContainerNode(node: RendererNode): node is FrameNode | SvgNode {
